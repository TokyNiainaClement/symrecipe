...
#[ORM\HasLifecycleCallbacks] // On doit mettre ça pour que le PrePersist fonctionne
#[Vich\Uploadable] // Indique que cette entity est téléchargable
#[UniqueEntity('name')]
...
class Recipe
{
    ...
    // S'éxecute avant chaque persist
    #[ORM\PrePersist()]
